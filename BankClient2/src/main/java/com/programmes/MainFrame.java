...
public class MainFrame extends JFrame implements Runnable, Observateur {
    ...
    /**
     * Cette méthode toggle on et off les boutons 'Se Connecter' et 'Se déconnecter'.
     * Ces boutons ne seront jamais actif en même temps.
     */
    public void toggleBoutonsConnection() {
        boolean enabled = miConnecter.isEnabled();
        miConnecter.setEnabled(!enabled);
        miDeconnecter.setEnabled(enabled);
    }
}